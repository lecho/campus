...
public class ZoomImageView extends ImageView implements View.OnTouchListener, ViewTreeObserver.OnGlobalLayoutListener {
	...
	/**
	 * 
	 * The ScrollerProxy encapsulates the Scroller and OverScroller classes. OverScroller is available since API 9.
	 * 
	 * @author tomasz.zawada@gmail.com
	 * 
	 */
	...
	private class ScrollerProxy {
		...
		public void fling(int startX, int startY, int velocityX, int velocityY, int minX, int maxX, int minY, int maxY,
			...
			if (isOld) {
				...
				((OverScroller) scroller).fling(startX, startY, velocityX, velocityY, minX, maxX, minY, maxY, overX,
						overY);
			}
		}
